...
<body>
 <!-- /////////////////////////////// -->
    ...
    echo '<a style="width: 120px;" href="index.php"   class="option-btn-admin" >home</a>';
...
<table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Product 2</td>
                <td>5</td>
                <td>Suspendisse eget est vel justo rhoncus mattis.</td>
                <td>$29.99</td>
            </tr>
            <tr>
                ...
                <td>Product 3</td>
                <td>8</td>
                <td>Nullam vehicula, dolor a feugiat vulputate, velit libero.</td>
                <td>$24.99</td>
            </tr>
        </tbody>
    </table>
